...
logging.basicConfig(filename='HuberLoss_training_log.log', level=logging.INFO)
...
# Change the criterion to Huber Loss
...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), 'HuberLoss_last_checkpoint.pth')
    if val_loss < best_val_loss:
        best_val_loss = val_loss
        torch.save(model.state_dict(), 'HuberLoss_best_model_checkpoint.pth')
